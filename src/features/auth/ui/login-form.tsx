        ...
        <div className="space-y-1.5 text-left">
          ...
          <div className="relative flex items-center group">
            ...
            <input
              ...
              className={`w-full rounded-2xl border bg-white/80 dark:bg-slate-950/50 backdrop-blur-2xl px-4 py-3 pl-11 text-sm text-slate-900 dark:text-white placeholder-slate-400 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-[#7A001E]/20 dark:focus:ring-red-500/20 shadow-inner ${errors.email
        ...
        <div className="space-y-1.5 text-left">
          ...
          <div className="relative flex items-center group">
            ...
            <input
              ...
              placeholder="••••••••••••"
              className={`w-full rounded-2xl border bg-white/80 dark:bg-slate-950/50 backdrop-blur-2xl px-4 py-3 pl-11 pr-11 text-sm text-slate-900 dark:text-white placeholder-slate-400 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-[#7A001E]/20 dark:focus:ring-red-500/20 shadow-inner ${errors.password
                ? 'border-rose-500 focus:ring-rose-500/30'
                : 'border-slate-200/90 dark:border-white/20 hover:border-slate-300 dark:hover:border-white/35 focus:border-[#7A001E] dark:focus:border-red-500'
                }`}
              {...register('password')}
